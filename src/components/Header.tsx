...
export function Header() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex gap-3 items-center relative z-10">
          ...
          <button
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.background = '#2d1263';
              (e.currentTarget as HTMLButtonElement).style.borderColor = '#a855f7';
              (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 12px #a855f740';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.background = '#1e0b3e';
              (e.currentTarget as HTMLButtonElement).style.borderColor = '#4c1d95';
              (e.currentTarget as HTMLButtonElement).style.boxShadow = 'none';
            }}
          >
            <BookOpen size={14} /> ELEMENTS
          </button>
      ...
      {/* Full-screen Elements Panel */}
      {showElements && <ElementsPanel onClose={() => setShowElements(false)} />}
    </>
  );
}
